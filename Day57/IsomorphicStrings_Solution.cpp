...
class Solution
{
    ...
    {
        //Here we are going to use famous character counting technique which uses
        //character as index to store frequecies in string.
        
        int m = str1.length(), n = str2.length();
        
        //if both string has different size then they can not be isomorphic 
        if (m != n)
            return false;
