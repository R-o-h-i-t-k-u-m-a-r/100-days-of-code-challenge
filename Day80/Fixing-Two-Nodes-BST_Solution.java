...
class Solution
{
    private Node prev=null, first=null, second=null;
    //Function to fix a given BST where two nodes are swapped.  
    public Node correctBST(Node root)
    {
        //We will use BST in-order traversal as it gives sorting data and wil use
        // extra three refrence of node named previous first and second to find two fixing nodes
        
        //this method will provide first and second node which need to fix
        getTwoNodes(root);
        
        //after getting two nodes swap both nodes data
        int temp=first.data;
    ...
    //Method for finding fixing two nodes
    public void getTwoNodes(Node root){
        //Implementiong inorder traversal 
        if(root==null) return;
        
        getTwoNodes(root.left);
        
        //at the current node we will process whether inorder traversal is sorted or not
